...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-indigo-950/80 to-gray-950 dark:from-gray-950 dark:via-indigo-950/90 dark:to-black flex flex-col">
      {/* Background patterns */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        {/* Radial light effect */}
        <div className="absolute top-1/4 left-1/4 w-1/2 h-1/2 bg-violet-600/5 rounded-full blur-[100px] animate-pulse" style={{animationDuration: '10s'}}></div>
        <div className="absolute bottom-0 right-0 w-full h-full bg-indigo-600/5 rounded-full blur-[120px] animate-pulse" style={{animationDuration: '15s', animationDelay: '2s'}}></div>
