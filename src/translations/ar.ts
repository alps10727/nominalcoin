...
export const ar = {
  ...
  "mining.description": "قم بالتعدين لربح عملة المستقبل المشفرة",
  "mining.active": "إيقاف",
  "mining.inactive": "بدء",
  ...
  "referral.description": "قم بدعوة الأصدقاء واربح مكافآت FC",
  ...
  "tasks.rewardClaimedDesc": "لقد ربحت {0} FC من {1}",
  ...
  "badges.socialNetworkerDesc": "قم بإحالة 5 أصدقاء إلى FC",
