...
export const pt = {
  ...
  "mining.title": "Mineração de FC",
  "mining.description": "Mine para ganhar criptomoeda Future Coin",
  "mining.active": "PARAR",
  ...
  "tasks.rewardClaimedDesc": "Você ganhou {0} FC de {1}",
  ...
  "badges.socialNetworkerDesc": "Indique 5 amigos para o FC",
