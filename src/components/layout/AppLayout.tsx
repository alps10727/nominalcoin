    ...
    <TooltipProvider>
      <div className="flex flex-col min-h-screen bg-gradient-to-b from-darkPurple-950 via-navy-950 to-darkPurple-950 relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          {/* Glowing orbs */}
          <div className="absolute top-1/4 -left-20 w-80 h-80 rounded-full bg-purple-700/10 blur-3xl"></div>
          <div className="absolute bottom-1/4 -right-20 w-96 h-96 rounded-full bg-indigo-700/10 blur-3xl"></div>
