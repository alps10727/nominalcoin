...
import { Zap, Users, ArrowUpRight, Shield, Award, Home } from "lucide-react";
...
const MobileNavigation = () => {
  ...
  // Mobil uygulamada navigasyon her zaman görünür olmalı
  return (
    <nav className="bg-gradient-to-r from-gray-950/95 via-indigo-950/90 to-purple-950/95 backdrop-blur-xl border-t border-violet-900/20 fixed bottom-0 left-0 right-0 flex justify-around p-2 z-10 shadow-[0_-4px_20px_rgba(0,0,0,0.3)] pb-safe">
