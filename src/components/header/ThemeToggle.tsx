...
export const ThemeToggle = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 rounded-full bg-gradient-to-br from-blue-800/80 to-navy-800/80 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
