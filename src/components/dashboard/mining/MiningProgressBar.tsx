...
export const MiningProgressBar = React.memo<MiningProgressBarProps>(({ 
  ...
  return (
    <div className="mb-6 mt-2">
      <div className="h-2.5 w-full bg-gradient-to-r from-navy-800/80 to-darkPurple-900/80 rounded-full overflow-hidden backdrop-blur-sm border border-navy-700/30">
        <div 
      ...
      {miningActive && (
        <div className="flex justify-between mt-1.5">
          <span className="text-xs text-cyan-300/80">Progress</span>
