...
export const MiningCardFooter: React.FC<MiningCardFooterProps> = ({ miningSession, miningRate }) => {
  return (
    <CardFooter className="flex flex-col sm:flex-row justify-between items-center gap-3 text-sm py-4 px-4 border-t border-purple-500/20 rounded-b-lg relative z-10 bg-gradient-to-b from-navy-900/40 to-darkPurple-950/70">
      {/* Power indicator with updated design */}
      <div className="flex items-center font-medium text-white w-full sm:w-auto">
        <div className="flex items-center gap-2 bg-gradient-to-br from-navy-800/50 to-darkPurple-900/50 px-4 py-2 rounded-xl border border-purple-500/30 w-full sm:w-auto justify-center sm:justify-start backdrop-blur-sm">
      ...
      <div className="flex items-center gap-3 flex-wrap justify-center w-full sm:w-auto">
        <div className="flex items-center gap-2 bg-gradient-to-br from-navy-800/50 to-darkPurple-900/50 px-4 py-2 rounded-xl border border-purple-500/30 backdrop-blur-sm">
