...
export const PulseRings = React.memo<PulseRingsProps>(({ miningActive }) => {
  if (miningActive) {
    return (
      <>
        <div className="absolute inset-0 rounded-full bg-cyan-500/20 animate-pulse-slow"></div>
        <div className="absolute -inset-2 rounded-full bg-indigo-500/15 animate-pulse-slow" 
          style={{animationDelay: '0.5s'}}></div>
        <div className="absolute -inset-4 rounded-full bg-purple-500/10 animate-pulse-slow" 
