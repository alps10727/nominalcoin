    ...
    <div className="relative flex flex-col items-center justify-center z-10">
      {miningActive ? (
        ...
        <>
          ...
          <span className="text-xs text-white font-bold tracking-wider bg-gradient-to-r from-purple-400 to-darkPurple-400 bg-clip-text text-transparent animate-cosmic-pulse transition-all duration-500">
            START
          </span>
        </>
      )}
