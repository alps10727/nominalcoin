...
export const MiningBackground = React.memo(() => {
  return (
    <>
      {/* Simple gradient background with darker purple colors */}
      <div className="absolute inset-0 bg-gradient-to-b from-darkPurple-900 to-darkPurple-950"></div>
...
MiningBackground.displayName = "MiningBackground";
