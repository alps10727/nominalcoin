...
const HeaderDecoration = () => {
  ...
  return (
    <div className="w-full relative mb-2 bg-navy-900/80 backdrop-blur-sm border-b border-teal-500/10">
      <div className="py-3">
        <div className="whitespace-nowrap flex items-center justify-between px-2">
          ...
          {/* Info item 3 */}
          <div className="inline-flex items-center px-3 py-1 rounded-full bg-navy-800/30 border border-navy-700/30">
