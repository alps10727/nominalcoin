...
const BalanceCard = ({ balance }: BalanceCardProps) => {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-900/90 to-gray-800/90 rounded-xl p-4 shadow-lg border border-gray-700/40">
      <div className="flex items-center mb-2">
        <div className="bg-blue-900/20 p-1.5 rounded-lg mr-2 border border-blue-500/20">
          <Diamond className="text-blue-300 h-4 w-4" />
        </div>
      ...
      <div className="flex flex-col space-y-2">
        <h1 className="text-3xl font-bold text-white">
          {balance.toLocaleString()} <span className="text-lg font-medium text-blue-300">NC</span>
        </h1>
        ...
        <div className="grid grid-cols-2 gap-2 pt-1">
          <div className="flex items-center space-x-1.5 bg-blue-900/20 px-2 py-1.5 rounded-lg border border-blue-500/20">
